    ...
    for i, atom in enumerate(atoms):
        for j in range(3):
            for sign in (-1,1):
                ...
                input_filename = f"atom_{i+1}_dir_{j+1}_{sign}.in"
                ...
                input_params = {
                    'control': {
                        ...
                        'prefix': f'atom_{i+1}_dir_{j+1}_{sign}', # unique prefix 
                        'pseudo_dir': './',  
                        'outdir': f'./tmp_{i+1}_{j+1}_{sign}', # unique outdir
                        'tprnfor': True,
                        'tstress': False,
                        'disk_io': 'none',
                    },
